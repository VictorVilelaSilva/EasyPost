// Source: MagicUI Design — https://magicui.design/r/iphone.json
...
export const IPHONE_SCREEN = {
    leftPct: (SCREEN_X / PHONE_WIDTH) * 100,
    topPct: (SCREEN_Y / PHONE_HEIGHT) * 100,
    widthPct: (SCREEN_WIDTH / PHONE_WIDTH) * 100,
    heightPct: (SCREEN_HEIGHT / PHONE_HEIGHT) * 100,
    radiusH: (SCREEN_RADIUS / SCREEN_WIDTH) * 100,
    radiusV: (SCREEN_RADIUS / SCREEN_HEIGHT) * 100,
};
        ...
        >
            {hasVideo && (
                <div
                    ...
                    style={{
                        left: `${IPHONE_SCREEN.leftPct}%`,
                        top: `${IPHONE_SCREEN.topPct}%`,
                        width: `${IPHONE_SCREEN.widthPct}%`,
                        height: `${IPHONE_SCREEN.heightPct}%`,
            ...
            >
                <g mask={hasMedia ? 'url(#iphoneScreenPunch)' : undefined}>
                    <path
                ...
                <path
                    ...
                    stroke="#E5E5E5"
                    strokeWidth="0.5"
                    mask={hasMedia ? 'url(#iphoneScreenPunch)' : undefined}
                />
