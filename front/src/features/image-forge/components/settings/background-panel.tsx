...
export function BackgroundPanel({
  ...
  return (
    <Panel>
      ...
      <div className="mt-4 grid grid-cols-[repeat(auto-fit,minmax(2.5rem,2.5rem))] gap-3">
      ...
      <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center">
        <Label className="flex w-full min-w-0 items-center justify-between gap-3 rounded-lg border border-[#2a2a2a] bg-[#0c0c0c] px-3 py-2 sm:max-w-xs">
          <span className="text-sm text-[#a3a3a3]">Cor selecionada</span>
          <span className="font-mono text-sm">{background.toUpperCase()}</span>
        </Label>
        <Label className="inline-flex w-full cursor-pointer items-center justify-center gap-3 rounded-lg border border-[#2a2a2a] px-4 py-2 text-sm font-semibold transition hover:bg-[#181818] sm:w-auto">
