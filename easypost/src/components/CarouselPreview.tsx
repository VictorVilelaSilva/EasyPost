        ...
        <>
            ...
            {lightboxIndex !== null && (
                ...
                >
                    ...
                    <button
                        onClick={closeLightbox}
                        className="cursor-pointer absolute top-4 right-4 z-50 w-10 h-10 rounded-full flex items-center justify-center transition-colors"
                    ...
                    <button
                        ...
                        className="cursor-pointer absolute left-3 sm:left-6 z-50 w-10 h-10 rounded-full flex items-center justify-center transition-colors"
                        style={{ background: 'rgba(255,255,255,0.1)', color: '#fff' }}
                    ...
                    <img
                        ...
                        alt={`Slide ${lightboxIndex + 1} ampliado`}
                    ...
                    <button
                        ...
                        className="cursor-pointer absolute right-3 sm:right-6 z-50 w-10 h-10 rounded-full flex items-center justify-center transition-colors"
                        style={{ background: 'rgba(255,255,255,0.1)', color: '#fff' }}
