...
function ColorPickerPopover({ color, onChange, onClose }: { color: string; onChange: (c: string) => void; onClose: () => void }) {
    ...
    return (
        <div
            ref={popoverRef}
            className="absolute bottom-full right-0 mb-2 rounded-xl border border-white/10 p-3 z-50 shadow-2xl"
